...
This project is a Learnify (LMS) built with React.js for the frontend, Spring Boot for the backend, and MySQL as the database. It provides a comprehensive platform for managing online courses, user profiles, assessments, progress tracking, and more.
...
1. Clone the repository:
    ...
    ```bash
    git clone https://github.com/Anugrah Pratap Singh/Learning-Management-System.git
    ```
